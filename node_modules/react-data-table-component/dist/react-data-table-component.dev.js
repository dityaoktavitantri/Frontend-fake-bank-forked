...
var TableCellCheckbox = function TableCellCheckbox(_ref) {
  ...
  var checked = isRowSelected(row, selectedRows, keyField);
...
var ColumnSortable = styled__default.div(_templateObject2$5(), function (props) {
  return props.sortActive && props.theme.headCells.activeStyle;
}, function (props) {
  return props.sortActive ? 'opacity: 1' : 'opacity: 0';
}, function (_ref) {
  var column = _ref.column;
...
var TableWrapper = styled__default.div(_templateObject$k());
...
var PaginationWrapper = styled__default.footer(_templateObject$n(), function (props) {
...
var PageList = styled__default.div(_templateObject3$4());
...
var createTheme = function createTheme(name) {
  ...
  defaultThemes[name] = merge_1(cloneDeep_1(defaultThemes["default"]), customTheme);
...
var createStyles = function createStyles() {
  ...
  return merge_1(defaultStyles(defaultThemes[themeType]), customStyles);
};
...
var DataTable = React.memo(function (_ref) {
  ...
  }), React__default.createElement(TableWrapper, null, progressPending && !persistTableHead && React__default.createElement(ProgressWrapper, null, progressComponent), React__default.createElement(TableStyle, {
    disabled: disabled,
    className: "rdt_Table"
  ...
  }) : React__default.createElement(TableColCheckbox, null)), expandableRows && React__default.createElement(CellBase, {
    head: true,
    style: {
      flex: '0 0 48px'
    }
